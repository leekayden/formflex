...
<div class="form-group col-sm-6 col-lg-5 scoped-responsive-fix-height">
    ...
    <i class="fa fa-question-circle text-success"
        data-toggle="tooltip"
        title="<?= gT("The question code is used for quick identification of this question and must be unique. It is especially useful if you wish to use the FormFlex assessments feature and/or the ExpressionScript."); ?>"
        ></i>
