            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title"><?php echo sprintf(gT("Welcome to %s!"), 'FormFlex'); ?></h4>
                    </div>
        ...
        <div class="alert alert-danger" role="alert" id="warningIE11">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <?php eT("FormFlex 3.x or newer does not support Internet Explorer for the FormFlex administration, anymore. However most of the functionality should still work."); ?><br/>
