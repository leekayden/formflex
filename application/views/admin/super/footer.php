...
$systemInfos = [
    gT('FormFlex version') => Yii::app()->getConfig('versionnumber'),
    gT('FormFlex build') => Yii::app()->getConfig('buildnumber') == '' ? 'github' : Yii::app()->getConfig('buildnumber'),
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-4 ">
                <a href='http://manual.limesurvey.org' onclick='function go(ev) { ev.preventDefault(); var win = window.open("https://manual.formflex.cloudservetechcentral.com/", "_blank"); win.focus(); }; go(event);'>
                    <span class="fa fa-question-circle" id="info-footer"></span>
            <span class="sr-only"><?php eT('FormFlex online manual'); ?></span>
                </a>
            </div>
            ...
            <div  class="col-xs-6 col-sm-4 text-center" >
                <a href='https://cloudservetechcentral.com/' target="_blank">
                    <img alt='FormFlex (formerly known as CloudserveForms) | Powered by CTS Services' title='FormFlex | Powered by CTS Services' src='<?php echo Yii::app()->getConfig('adminimageurl');?>donate.png'/>
                </a>
            </div>

            <div class="col-xs-12 col-sm-4 text-right">
                <a  title='<?php eT("Visit our website!"); ?>' href='https://cloudservetechcentral.com/formflex' target='_blank'>FormFlex Community Edition</a><br />
