...
class LsDefaultDataSets
{
    ...
    public static function getBoxesData()
    {
        ...
        $returnArray[] = ['position' => 5, 'url' => 'https://account.limesurvey.org/limestore', 'title' => 'LimeStore', 'ico' => 'fa fa-cart-plus', 'desc' => gT('FormFlex extension marketplace'), 'page' => 'welcome', 'usergroup' => '-2'];
    ...
    public static function getTutorialEntryData()
    {
        ...
        $returnArray['firstStartTour'] = array(
            ...
            array(
                ...
                . gT('In FormFlex a survey is organized in groups and questions. To begin creating questions, we first need a question group.')
