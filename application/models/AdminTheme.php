...
class AdminTheme extends CFormModel
{
    ...
    private function defineConstants()
    {
        ...
        if (isset($this->config->metadata->presentation) && $this->config->metadata->presentation) {
            ...
            define('PRESENTATION', gT('Welcome to FormFlex (formerly known as CloudserveForms)! Flexible forms for a dynamic world. You are currently using the modern version. The classic version is deprecated.'));
        }
    }
